    ...
    <>
      ...
      <section className='text-center second' id='aboutme'>
        ...
        <Jump bottom>
          ...
          <p className='text-center mt-3 mr-5  '> Hi! 你好, I&apos;m a Full-stack Wed Developer and a recent software engineering graduate from General Assembly (June 2022).
            Current Stack: HTML, CSS, JavaScript, React.js, Express.js, Python, Django.<br></br>I’m a nice, fun and friendly person, I’m honest and punctual, I work well in a team but also on my own and I have good listening and communication skills.
          <br></br> In addition, being a mother has helped me to go through this course even though it was very challenging, as I wanted to set an example for my daughter so that she would not give up on her dreams.
            Now that I have completed the course, I’d like to find a place where I can work in a trusting, goal-oriented, and supportive environment. </p>
